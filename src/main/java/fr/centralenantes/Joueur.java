...
/**
 * Représente un joueur dans la partie de Monopoly. Gère sa fortune, sa position
 * sur le plateau et ses actions de jeu.
 *
 * @author
 */
public class Joueur {
    ...
    /**
     * Construit un nouveau joueur. La fortune est initialisée à 100000€ et la
     * position à 0 (Case Départ).
     *
     * @param nom Le nom du joueur.
     * @param plateau La référence au plateau de jeu sur lequel le joueur
     * évolue.
     */
    ...
    /**
     * Met à jour la position du joueur. (Logique de passage par la case départ
     * non implémentée ici, [cite_start]gérée par setPosition(int pos) dans le
     * diagramme [cite: 71] si besoin)
     *
    ...
    /**
     * Retire un montant de la fortune du joueur. Lève une exception si le
     * joueur ne peut pas payer.
     *
     * @param montant Le montant à débiter. [cite_start]@throws NoMoreMoney Si
     * la fortune est insuffisante[cite: 157].
     */
     ...
     * @param montant Le montant à payer. [cite_start]@throws NoMoreMoney Si le
     * joueur payeur n'a pas les fonds suffisants[cite: 157].
     */
    ...
    /**
     * Exécute les actions d'un tour de jeu pour ce joueur. 1. Lance le dé. 2.
     * Avance sur le plateau. 3. Effectue une action (acheter ou payer) selon la
     * case d'arrivée.
     */
    ...
    public void tourDeJeu() throws NoMoreMoney {
        ...
        if (this.plateau.caseAt(new_position) instanceof Achetable) {
            ...
            if (prop.estLibre()) {
                ...
                int loyer = prop.calculLoyer(this.plateau, prop.getProprietaire());
